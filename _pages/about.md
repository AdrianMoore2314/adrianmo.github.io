...
I am <strong>Mingqiao Mo</strong>, currently an intern at the <strong>University of the Chinese Academy of Sciences (UCAS)</strong>. I have also conducted research and academic internships at <strong>Cornell University</strong>, <strong>UCLA</strong>, and <strong>Tsinghua University</strong>.
...
- *2026.05.13*: &nbsp;🎉🎉 Our paper was selected for an **Oral presentation** at **ICME 2026**.
...
[ShieldedCode: Learning Robust Representations for Virtual Machine Protected Code]([https://openreview.net/pdf?id=9F9UFVcDkV])<span style="display:inline-block; padding:2px 8px; margin-left:6px; font-size:0.78em; font-weight:700; color:#fff; background:#3e608b; border-radius:6px; line-height:1.2;">Poster</span>
...
[CTR-LoRA: Curvature-Aware and Trust-Region Guided Low-Rank Adaptation for Large Language Models]([https://arxiv.org/pdf/2510.15962])<span style="display:inline-block; padding:2px 8px; margin-left:6px; font-size:0.78em; font-weight:700; color:#fff; background:#8d2f25; border-radius:6px; line-height:1.2;">Oral</span>
...
[Self-Supervised Visual Prompting for Cross-Domain Road Damage Detection]([https://openaccess.thecvf.com/content/WACV2026/papers/Xiao_Self-Supervised_Visual_Prompting_for_Cross-Domain_Road_Damage_Detection_WACV_2026_paper.pdf])<span style="display:inline-block; padding:2px 8px; margin-left:6px; font-size:0.78em; font-weight:700; color:#fff; background:#3e608b; border-radius:6px; line-height:1.2;">Poster</span>
